...
resource "azurerm_linux_virtual_machine" "VM-WEB" {
  ...
  custom_data = data.template_cloudinit_config.config_web.rendered
...
output "public_ip" {
  value = azurerm_linux_virtual_machine.VM-WEB.public_ip_address
}
